...
{
    public partial class Album_Search : UserControl
    {
        public Album_Search()
        {
            InitializeComponent();
        ...
        private void SearchButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(connectionString))
                {
                    ...
                    string search_Album = "SELECT * FROM ALBUM where " + Column + " " + condition + " @Value";
                    using (SqlCommand cmd = new SqlCommand(search_Album, con))
                    {
