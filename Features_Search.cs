...
{
    public partial class Features_Search : UserControl
    {
        ...
        private void SearchButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(connectionString))
                {
                    ...
                    string search_Features = "SELECT * FROM Features where " + Column + " " + condition + " @Value";
                    using (SqlCommand cmd = new SqlCommand(search_Features, con))
                    {
